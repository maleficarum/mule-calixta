 ...
 */
package mx.maleficarum.calixta.config;

import org.mule.construct.SimpleFlowConstruct;
import org.mule.tck.FunctionalTestCase;

public class CalixtaNamespaceHandlerTestCase extends FunctionalTestCase
{
    @Override
    protected String getConfigResources()
    {
        return"calixta-namespace-config.xml";
    }
    ...
    /*
        ...
        calixta-namespace-config.xml and put the element from your
        cloud connector's namespace that you want to test into it.
        A proper example was put into calixta-namespace-config.xml
